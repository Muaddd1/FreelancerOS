...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-zinc-900 text-white hover:bg-zinc-800 hover:scale-[1.02] hover:shadow-sm dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200',
        destructive: 'bg-red-500 text-white hover:bg-red-600 hover:scale-[1.02] hover:shadow-sm',
        ...
        ghost: 'hover:bg-zinc-100 dark:hover:bg-zinc-800 dark:hover:text-zinc-100',
